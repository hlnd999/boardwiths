...
<body>
		...
		<!-- 게시판 top -->
			<div class="container d-flex justify-content-between mb-3">
	        	<!--  게시판 표시 -->
	        	<a class="d-flex text-black text-decoration-none fw-bold fs-5" href="${ contextPath }/myBoardList.us">
	        		작성글
				</a>
	        ...
	        <table class="table table-hover align-middle">
	            <thead>
	                <tr>
	                    ...
	                    <th scope="col">글제목</th>
	                    <th scope="col" width="120px">작성일자</th>
...
window.onload = () => {
	...
	delBtn.addEventListener('click', () => {
		for(const checkBox of checkBoxList) {
			if(checkBox.checked) {
				const boardNo = checkBox.parentElement.nextElementSibling.children[0].value;
		...
		$.ajax({ //동기처리 => async: false
			url: '${contextPath}/deleteMyBoard.us',
			type: 'GET',
			data: {boardNoArr: boardNoArr},
			success: data => {
				if(data == 'success') {
					location.href='${contextPath}/myBoardList.us';
				}
			}
		})
