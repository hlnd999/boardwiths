...
<body>
        ...
        <div class="container d-flex justify-content-between mb-3">
        	<a class="d-flex text-black text-decoration-none fw-bold fs-5" href="${contextPath}/sendMessage.us" >보낸 쪽지함</a>
     	</div>
	        ...
	        <table class="table table-hover align-middle">
	            <thead>
	                <tr>
	                    ...
	                    <th scope="col" width="200px">받은사람</th>
	                    <th scope="col">내용</th>
...
window.onload = () => {
	...
	for(const td of tds){
		td.addEventListener('click', function(){
			...
			location.href='${contextPath}/sendMessageDetail.us?noteNo='+ noteNo ;
	...
	delBtn.addEventListener('click', () => {
		...
		$.ajax({ //동기처리 => async: false
			...
			success: data => {
				if(data == 'success') {
					location.href='${contextPath}/sendMessage.us';
				}
			}
		})
