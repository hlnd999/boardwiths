...
<body>
    <div class="container d-flex m-auto" style="width: 1440px;">
		...
		<c:set var="contextPath" value="${ pageContext.request.contextPath }"/>
			...
			<div id="content2-2" class="d-inline-block col-7 p-3 mb-2 bg-secondary text-white">
				<div id="gameInfo">
				         ...
				         제조사 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <span id="gameCompanySpan">${g.gameCompany}</span><br/>
				         게임장르 &nbsp;&nbsp;&nbsp;: <span id="gameGenreSpan">${g.gameGenre}</span><br/>
				         게임시간 &nbsp;&nbsp;&nbsp;: <span id="gamePlayTimeSpan">${g.gamePlayTime}</span>분<br/>
				         게임난이도 : <span id="gameLevelSpan">${g.gameLevel}</span><br/>
				         게임인원 &nbsp;&nbsp;&nbsp;: <span id="gamePeopleSpan">${g.gamePeople}</span>명<br/>
		...
		<!-- 가격 상태 입력창 -->
        <hr>
        <form action="updateBSBoard.bo" enctype="multipart/form-data" id="boardForm" method="POST" >
        	...
        	<div class="input-group input-group-sm mb-3">
	        	...
	        	<input class="form-control form-control-sm" style="width: 200px" name="price" type="text" placeholder="가격을 입력해주세요." id="price" value="${bMarket.price}">
			</div>
			...
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="category" id="buyRadio" value="2" <c:if test="${ b.category eq 2 }">checked</c:if>>
				<label class="form-check-label" for="inlineRadio1">구매글 작성</label>
			</div>
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="category" id="sellRadio" value="3" <c:if test="${ b.category eq 3 }">checked</c:if>>
			...
			<button class="btn btn-primary" id="writeUI">글수정</button>
			<hr/>
		</form>
